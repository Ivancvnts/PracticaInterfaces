...
class AUTAD_UI_FPSCharacter : public ACharacter
{
	...
	/** PoweUpsTree Input Action*/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Input, meta=(AllowPrivateAccess = "true"))
	class UInputAction* PowerUpsAction;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = UI)
	TSubclassOf<UPowerUpsTree> PowerUpsTreeWidget;
...
protected:
	...
	void OpenPowerUpsTree(const FInputActionValue & Value);
...
private:
	...
	TObjectPtr<UPowerUpsTree> PowerUpsTreeInstance;
